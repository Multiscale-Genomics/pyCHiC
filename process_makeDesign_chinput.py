...
from tools.bam2chicago_Tool import bam2chicagoTool

#####################################################

class makeDesign_chinput(Workflow):
    """
    ...
    def __init__(self, configuration=None):
        ...
        logger.info("Generating CHiCAGO input files:"+
                    "makeDesign and chinput files")
    ...
    def run(self, input_files, input_metadata, output_files):
        ...
        makeDesign_caller = makeDesignFilesTool(config_file)
        ...
        bam2chicago_caller = bam2chicagoTool()
        bam2chicago_out, bam2chicago_outMeta = bam2chicago_caller.run(
            {
                "bamfile" : input_files["bamfile"],
                "rmapFile" : input_files["rmapFile"],
                "baitmap" : input_files["baitmap"]
            },
            {
                "bam_1" : input_metadata["bam_1"],
                "bsgemoe" : input_metadata["bsgenome"]
            },
            {
