...
def test_chicago():
    ...
    """
    input_files = {"chinput_files" : 
                    "/Users/pacera/MuG/chicagoTeam-chicago-ceffddda8ea3/"+
                     "PCHiCdata/inst/extdata/GMchinputFiles/GM_rep1.chinput"}
                    # "/Users/pacera/MuG/chicagoTeam-chicago-ceffddda8ea3/"+
                    # "PCHiCdata/inst/extdata/GMchinputFiles/GM_rep2.chinput"]
                 # }

    output_files = { "output_dir" : "/Users/pacera/MuG/chicagoTeam-chicago-ceffddda8ea3/PCHiCdata/output__",
                    "output_prefix" : "output_test"}



    metadata = { "chinput_1" : Metadata(
                    "data_chicago", "chinput",[], None,
                     None, 9606),
                "chinput_2" : Metadata(
                    "data_chicago", "chinput",[], None,
                     None, 9606)
