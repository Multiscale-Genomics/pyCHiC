...
def test_Design_process():
    ...
    input_files = {
        "designDir" : path + "test_process_Design"
    }
    ...
    assert os.path.isfile(path + "test_process_Design/h19_chr20and21_test" + ".nbpb") is True
    assert os.path.getsize(path + "test_process_Design/h19_chr20and21_test" + ".nbpb") > 0

    assert os.path.isfile(path + "test_process_Design/h19_chr20and21_test" + ".npb") is True
    assert os.path.getsize(path + "test_process_Design/h19_chr20and21_test" + ".npb") > 0

    assert os.path.isfile(path + "test_process_Design/h19_chr20and21_test" + ".poe") is True
    assert os.path.getsize(path + "test_process_Design/h19_chr20and21_test" + ".poe") > 0
